...
#define EXP2_08_PIN                        -1
  ...
  // Custom definition for the screen
    ...
    CONTROLLER_WARNING("BTT_SKR_V1_3", "ZONESTAR_LCD")
    ...
    #define ADC_KEYPAD_PIN           EXP1_01_PIN  // CONNECTING TO 5V WILL DAMAGE THE BOARD!
...
// Custom setting: enable onboard SD support
#define SDCARD_CONNECTION ONBOARD
