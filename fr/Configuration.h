...
#define STRING_CONFIG_H_AUTHOR "Romain THOMAS" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 140, 140, 8, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32, -2, -2 }
...
// // Custom definition for the screen
...
//   #define ADC_KEYPAD_PIN           EXP1_01_PIN  // Repurpose servo pin for ADC - CONNECTING TO 5V WILL DAMAGE THE BOARD!
